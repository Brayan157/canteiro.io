...
public class AccountActivationTokenJpaEntity extends BaseJpaEntity {
    ...
    public AccountActivationTokenJpaEntity(UUID userId, String tokenHash, Instant expiresAt) {
        this.userId = userId;
